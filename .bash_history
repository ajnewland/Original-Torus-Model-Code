...
chmod +x startup.sh
gcloud compute instances create hk-ds4-spot   --zone=europe-west2-b   --machine-type=e2-standard-8   --provisioning-model=SPOT --instance-termination-action=STOP   --image-family=debian-12 --image-project=debian-cloud   --boot-disk-size=50GB   --metadata-from-file startup-script=startup.sh   --metadata HK_NODES=2400,HK_RUNS=64,HK_HUTCH_M=256,HK_GCS_DST=gs://$BUCKET/hk_ds4   --scopes=cloud-platform
top -n 1 | grep python
gcloud compute ssh hk-ds4-spot --zone=europe-west2-b
gcloud compute ssh hk-ds4-spot --project=montyecarlo-run-for-ds --zone=europe-west2-b --troubleshoot --tunnel-through-iap
ERROR: (gcloud.compute.ssh) [/usr/bin/ssh] exited with r
gcloud compute ssh hk-ds4-spot --zone=europe-west2-b
gcloud config unset compute/use_iap_tunnel
gcloud config set project montyecarlo-run-for-ds
gcloud compute ssh hk-ds4-spot --zone=europe-west2-b
gcloud compute instances list --filter="name=hk-ds4-spot"
gcloud compute instances start hk-ds4-spot --zone=europe-west2-b
gcloud compute instances add-access-config hk-ds4-spot   --zone=europe-west2-b   --network-interface=nic0
gcloud compute instances start hk-ds4-spot --zone=europe-west2-b
sudo tail -n 30 /var/hk_runs/out/hk_run.log
ls -lh /var/hk_runs/out
gcloud compute instances start hk-ds4-spot --zone=europe-west2-b
top -n 1 | grep python
gcloud compute instances list
gcloud compute ssh hk-ds4-spot --zone=europe-west2-b
mkdir -p "C:\Users\anthoni.newland\OneDrive - ZINUS\Desktop\New Results\hk_results_local"
gcloud compute scp --recurse   --zone=europe-west2-b   hk-ds4-spot:/var/hk_runs/out ./hk_results_local
ls -lh hk_results_local
